...
export default function MessageBoard() {
  ...
  function handlePost() {
    ...
    setNotes((prev) => [
      ...prev,
      { id: crypto.randomUUID(), content: composeText.trim(), x, y },
    ]);
    setComposeText("");
    setPillsExiting(true);
    setModalAnim("shrink");
      ...
      {showBoard &&
        notes.map((note) => (
          <div
            ...
            className={`absolute w-[300px] h-[200px] z-[5] transition-transform duration-150 ease-out hover:scale-110 ${boardFadingOut ? "animate-[board-fade-out_0.5s_ease-out_forwards]" : ""}`}
